...
export function LiquidGlassTheme() {
  ...
  return (
    <div
      className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-slate-950 px-4 py-20 text-slate-100 sm:px-6 sm:py-24 md:py-12"
      ...
      <motion.main
        ...
        <motion.div
          aria-hidden
          className="pointer-events-none absolute inset-0 rounded-[1.75rem] sm:rounded-[2rem] md:rounded-[2.5rem]"
          style={{
        ...
        <motion.span
          ...
          className="relative z-10 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/10 px-3 py-1.5 text-[0.6rem] font-medium uppercase tracking-[0.18em] text-slate-200 sm:gap-2 sm:px-5 sm:py-2 sm:text-xs sm:tracking-[0.35em]">
          <span className="h-1.5 w-1.5 rounded-full bg-cyan-300 drop-shadow-glow sm:h-2 sm:w-2" />
        ...
        <motion.div
          ...
          <h1 className="text-[1.875rem] font-semibold leading-[1.05] sm:text-4xl md:text-5xl lg:text-6xl">
            Alagappan N
          </h1>
          <motion.p
            variants={bodyVariants}
            className="max-w-xl text-[0.875rem] leading-[1.55] text-slate-300 sm:text-base md:text-xl">
            ...
            {links.map((link, index) => (
              <motion.li
                ...
                <motion.a
                  ...
                  className="group relative flex flex-col gap-0.5 overflow-hidden rounded-lg border border-white/10 bg-white/5 px-3 py-2 transition-all duration-500 hover:border-white/30 hover:bg-white/10 sm:rounded-xl sm:px-4 sm:py-3"
                  whileHover={{ y: -2, scale: 1.01 }}
                  whileTap={{ scale: 0.99 }}>
                  <div className="flex items-center justify-between">
                    <span className="text-[0.875rem] font-semibold sm:text-base">
                      {link.label}
                    </span>
                    <div className="flex items-center gap-1 sm:gap-2">
                      {link.type === 'email' && (
                        <motion.button
                          ...
                          className="flex h-6 w-6 items-center justify-center rounded-full border border-white/20 bg-white/10 transition-colors hover:bg-white/20 sm:h-7 sm:w-7"
                          ...
                          {copiedEmail ? (
                            <svg
                              ...
                              viewBox="0 0 20 20"
                              fill="currentColor"
                              className="h-3 w-3 text-green-400 sm:h-3.5 sm:w-3.5">
                              <path
                                fillRule="evenodd"
                            ...
                            <svg
                              ...
                              viewBox="0 0 20 20"
                              fill="currentColor"
                              className="h-3 w-3 text-cyan-200 sm:h-3.5 sm:w-3.5">
                      ...
                      <motion.span
                        className="flex h-6 w-6 items-center justify-center rounded-full border border-white/20 bg-white/10 sm:h-7 sm:w-7"
                  ...
                  <p className="text-[0.65rem] leading-[1.2] text-slate-300/70 sm:text-xs">{link.caption}</p>
        ...
        <motion.div
          className="relative z-10 flex items-center gap-1.5 text-[0.65rem] text-slate-400 sm:gap-3 sm:text-sm"
          variants={bodyVariants}>
          <motion.span
            className="relative flex h-7 w-7 items-center justify-center overflow-hidden rounded-lg border border-white/10 bg-white/5 sm:h-10 sm:w-10 sm:rounded-2xl"
            animate={{ y: [0, -2, 0] }}
            transition={{
              duration: 3,
              repeat: Infinity,
          ...
          <span className="text-[0.75rem] leading-[1.2] sm:text-sm">Based in Hyderabad, India</span>
        </motion.div>
      </motion.main>
    </div>
  )
